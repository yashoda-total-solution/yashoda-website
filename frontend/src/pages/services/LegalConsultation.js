        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              Professional legal consultation services to help you understand your rights and resolve legal matters effectively.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-[#52606D] leading-relaxed mb-8">
              We are currently preparing comprehensive information about our Legal Consultation services. Please check back soon or contact us directly for immediate assistance.
            </p>
            <Link
              to="/contact"
