...
const LEGAL_CONSULTATION_STRUCTURED_DATA = {
  '@context': 'https://schema.org',
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.yashodatotalsolution.in/legal-consultation/#webpage',
      url: 'https://www.yashodatotalsolution.in/legal-consultation/',
      name: 'Legal Consultation Services India | Yashoda Total Solution',
      isPartOf: { '@id': 'https://www.yashodatotalsolution.in/#website' },
      description:
        'Get expert legal consultation for insurance disputes, financial conflicts, contract disagreements and legal notices in India. Yashoda Total Solution provides professional case review, document analysis and legal guidance before taking formal action.',
      breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [
          {
          ...
          },
          {
            ...
            item: 'https://www.yashodatotalsolution.in/legal-consultation/',
          },
        ],
      },
    },
    {
      '@type': 'Service',
      '@id': 'https://www.yashodatotalsolution.in/legal-consultation/#service',
      name: 'Legal Consultation Services',
      description:
        'Professional legal consultation for insurance disputes, financial conflicts, contract disagreements and legal notices. We review your documents, analyse case strength, discuss options and provide clear recommendations before any formal legal action.',
      provider: { '@id': 'https://www.yashodatotalsolution.in/#organization' },
      areaServed: { '@type': 'Country', name: 'India' },
      serviceType: 'Legal Consultation and Case Evaluation',
      url: 'https://www.yashodatotalsolution.in/legal-consultation/',
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What is a legal consultation?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Legal consultation is a discussion with legal professionals to understand a legal issue, review your documents and evaluate possible options before taking any formal legal action.',
          },
        },
        {
          '@type': 'Question',
          name: 'What should someone bring to a legal consultation?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Relevant documents, agreements, communication records and details related to the dispute can help provide a clearer understanding of your situation and strengthen the case review.',
          },
        },
        {
          '@type': 'Question',
          name: 'Can legal consultation help determine whether a case is strong?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes, reviewing the documents and facts can help identify the strengths, weaknesses and potential risks of your case before you decide to proceed with formal legal action.',
          },
        },
        {
          '@type': 'Question',
          name: 'Is legal consultation useful before sending a legal notice?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes, consultation can help determine whether sending a legal notice or taking further action is appropriate for your specific situation and what outcome you can realistically expect.',
          },
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F9]">
      ...
      <Helmet prioritizeSeoTags>
        {/* Primary */}
        <title>Legal Consultation Services India | Yashoda Total Solution</title>
        <meta
          name="description"
          content="Need legal consultation in India? Yashoda Total Solution provides expert case review, document analysis & legal guidance for insurance disputes, financial conflicts, contract issues & legal notices. Free consultation available. Call now."
        />
        <meta
          name="keywords"
          content="legal consultation India, legal advice insurance dispute India, legal consultation Mumbai, insurance claim legal help, contract dispute legal advice, legal notice help India, legal case evaluation India, legal guidance financial dispute, free legal consultation India"
        />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta name="author" content="Yashoda Total Solution" />

        {/* Canonical */}
        <link rel="canonical" href="https://www.yashodatotalsolution.in/legal-consultation/" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.yashodatotalsolution.in/legal-consultation/" />
        <meta property="og:title" content="Legal Consultation Services India | Yashoda Total Solution" />
        <meta
          property="og:description"
          content="Expert legal consultation for insurance disputes, financial conflicts, contract issues and legal notices. We review your case, analyse documents and provide clear guidance before formal action."
        />
        <meta property="og:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Legal Consultation Services – Yashoda Total Solution" />
        <meta property="og:site_name" content="Yashoda Total Solution" />
        <meta property="og:locale" content="en_IN" />

        {/* Twitter / X Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Legal Consultation Services India | Yashoda Total Solution" />
        <meta
          name="twitter:description"
          content="Expert legal consultation for insurance disputes, financial conflicts, contract issues and legal notices. Case review, document analysis and clear guidance."
        />
        <meta name="twitter:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta name="twitter:image:alt" content="Legal Consultation Services – Yashoda Total Solution" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(LEGAL_CONSULTATION_STRUCTURED_DATA)}
        </script>
      </Helmet>
          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-[#52606D]">
              ...
              <p className="leading-relaxed mb-4">
                {t('what_legal_description3')}{' '}
                <strong>{t('what_legal_description4')}</strong>
                {t('what_legal_description5')}
              </p>
              <p className="leading-relaxed mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-semibold text-red-600 mb-2">
                      {t('ex_scenario_legal_problem_label')}
                    </h4>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              { question: t('faq_legal_q1'), answer: t('faq_legal_a1') },
              { question: t('faq_legal_q2'), answer: t('faq_legal_a2') },
              { question: t('faq_legal_q3'), answer: t('faq_legal_a3') },
              { question: t('faq_legal_q4'), answer: t('faq_legal_a4') },
            ].map((faq, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  ...
                  aria-label="Get free legal consultation"
                >
                  {t('cta_legal_button1')}
