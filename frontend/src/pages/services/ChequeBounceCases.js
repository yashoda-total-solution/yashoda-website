        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              Professional legal support for cheque dishonour cases and recovery proceedings under the Negotiable Instruments Act.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-[#52606D] leading-relaxed mb-8">
              We are currently preparing comprehensive information about our Cheque Bounce Cases services. Please check back soon or contact us directly for immediate assistance.
            </p>
            <Link
              to="/contact"
