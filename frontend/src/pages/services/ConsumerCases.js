...
const CONSUMER_CASES_STRUCTURED_DATA = {
  '@context': 'https://schema.org',
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.yashodatotalsolution.in/consumer-cases/#webpage',
      url: 'https://www.yashodatotalsolution.in/consumer-cases/',
      name: 'Consumer Protection Support India | File Consumer Complaint | Yashoda Total Solution',
      isPartOf: { '@id': 'https://www.yashodatotalsolution.in/#website' },
      description:
        'Get expert consumer protection support in India. Yashoda Total Solution helps you file complaints for defective products, poor service, misleading advertisements, overcharging and refund refusal under Consumer Protection Act 2019.',
      breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [
          {
          ...
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Consumer Protection Support',
            item: 'https://www.yashodatotalsolution.in/consumer-cases/',
          },
        ],
      },
    },
    {
      '@type': 'Service',
      '@id': 'https://www.yashodatotalsolution.in/consumer-cases/#service',
      name: 'Consumer Protection Support Services',
      description:
        'Expert consumer protection assistance for defective products, poor service quality, misleading advertisements, overcharging and refund disputes. We draft complaints, file with consumer forums, follow up and ensure you receive rightful compensation under Consumer Protection Act 2019.',
      provider: { '@id': 'https://www.yashodatotalsolution.in/#organization' },
      areaServed: { '@type': 'Country', name: 'India' },
      serviceType: 'Consumer Complaint Filing and Dispute Resolution',
      url: 'https://www.yashodatotalsolution.in/consumer-cases/',
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What is consumer protection support?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Consumer protection support involves understanding your rights as a consumer and addressing disputes related to products or services under the Consumer Protection Act 2019, including defective goods, poor service, misleading advertisements and refund disputes.',
          },
        },
        {
          '@type': 'Question',
          name: 'What types of issues can be raised under consumer protection?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Issues such as defective goods, poor service quality, misleading advertisements, overcharging and refund disputes may be addressed under consumer protection laws in India.',
          },
        },
        {
          '@type': 'Question',
          name: 'What documents are required for a consumer complaint?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Typical documents include purchase invoices, communication records with the seller or service provider, product details, photographs of defects, and a clear description of the issue faced.',
          },
        },
        {
          '@type': 'Question',
          name: 'Can online purchase disputes be raised under consumer protection laws?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes, disputes related to online purchases from e-commerce platforms also fall under consumer protection regulations in India. You can file a complaint against e-commerce companies for wrong products, non-delivery or refund issues.',
          },
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F9]">
      ...
      <Helmet prioritizeSeoTags>
        {/* Primary */}
        <title>Consumer Protection Support India | File Consumer Complaint | Yashoda Total Solution</title>
        <meta
          name="description"
          content="Facing defective product, poor service, misleading ad or refund refusal? Yashoda Total Solution helps you file consumer complaints under Consumer Protection Act 2019. Expert support for consumer forum cases across India. Free consultation."
        />
        <meta
          name="keywords"
          content="consumer complaint India, consumer protection support India, file consumer complaint forum, defective product complaint India, Consumer Protection Act 2019, misleading advertisement complaint, refund refusal complaint, consumer forum case help Mumbai, online purchase dispute complaint, consumer court help India"
        />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta name="author" content="Yashoda Total Solution" />

        {/* Canonical */}
        <link rel="canonical" href="https://www.yashodatotalsolution.in/consumer-cases/" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.yashodatotalsolution.in/consumer-cases/" />
        <meta property="og:title" content="Consumer Protection Support India | File Consumer Complaint | Yashoda Total Solution" />
        <meta
          property="og:description"
          content="Facing defective product, poor service, misleading ad or refund refusal? We help you file consumer complaints, escalate to consumer forum and get rightful compensation under Consumer Protection Act 2019."
        />
        <meta property="og:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Consumer Protection Support – Yashoda Total Solution" />
        <meta property="og:site_name" content="Yashoda Total Solution" />
        <meta property="og:locale" content="en_IN" />

        {/* Twitter / X Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Consumer Protection Support India | File Consumer Complaint | Yashoda Total Solution" />
        <meta
          name="twitter:description"
          content="Defective product, poor service or refund refusal? We help file consumer complaints and get compensation under Consumer Protection Act 2019."
        />
        <meta name="twitter:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta name="twitter:image:alt" content="Consumer Protection Support – Yashoda Total Solution" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(CONSUMER_CASES_STRUCTURED_DATA)}
        </script>
      </Helmet>
      ...
      <section
        ...
        aria-labelledby="consumer-hero-heading"
      >
          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-[#52606D]">
              ...
              <p className="leading-relaxed mb-4">
                <strong>{t('what_consumer_description4')}</strong>{' '}
                {t('what_consumer_description5')}
              </p>
              <p className="leading-relaxed mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-semibold text-red-600 mb-2">
                      {t('ex_scenario_consumer_problem_label')}
                    </h4>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              { question: t('faq_consumer_q1'), answer: t('faq_consumer_a1') },
              { question: t('faq_consumer_q2'), answer: t('faq_consumer_a2') },
              { question: t('faq_consumer_q3'), answer: t('faq_consumer_a3') },
              { question: t('faq_consumer_q4'), answer: t('faq_consumer_a4') },
            ].map((faq, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  ...
                  aria-label="Get free consultation for consumer complaint"
                >
