        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-white text-sm">Consumer Cases</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              Comprehensive support for consumer rights protection and dispute resolution in consumer matters.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-[#52606D] leading-relaxed mb-8">
              We are currently preparing comprehensive information about our Consumer Cases services. Please check back soon or contact us directly for immediate assistance.
            </p>
            <Link
              to="/contact"
