...
const CLAIM_REJECTION_STRUCTURED_DATA = {
  '@context': 'https://schema.org',
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.yashodatotalsolution.in/claim-rejection/#webpage',
      url: 'https://www.yashodatotalsolution.in/claim-rejection/',
      name: 'Insurance Claim Rejection Help India | Yashoda Total Solution',
      isPartOf: { '@id': 'https://www.yashodatotalsolution.in/#website' },
      description:
        'Has your insurance claim been rejected? Yashoda Total Solution helps policyholders understand rejection reasons, challenge decisions, and escalate to Insurance Ombudsman or IRDAI. Free consultation available.',
      breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [
          {
          ...
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Insurance Claim Rejection',
            item: 'https://www.yashodatotalsolution.in/claim-rejection/',
          },
        ],
      },
    },
    {
      '@type': 'Service',
      '@id': 'https://www.yashodatotalsolution.in/claim-rejection/#service',
      name: 'Insurance Claim Rejection Assistance',
      description:
        'Expert assistance for policyholders whose insurance claims have been rejected. We review rejection reasons, prepare appeals, and escalate to the Insurance Ombudsman or IRDAI when necessary.',
      provider: { '@id': 'https://www.yashodatotalsolution.in/#organization' },
      areaServed: { '@type': 'Country', name: 'India' },
      serviceType: 'Insurance Claim Rejection Support',
      url: 'https://www.yashodatotalsolution.in/claim-rejection/',
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What does insurance claim rejection mean?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Insurance claim rejection means that the insurance company has declined the claim request based on policy conditions, incomplete documentation, or other stated reasons.',
          },
        },
        {
          '@type': 'Question',
          name: 'Can a rejected insurance claim be reviewed or challenged?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. In many cases, policyholders can review the rejection reasons and file a formal appeal or complaint with the insurer\'s grievance cell, and if unresolved, escalate to the Insurance Ombudsman or IRDAI.',
          },
        },
        {
          '@type': 'Question',
          name: 'What documents are required for an insurance claim?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Required documents vary depending on the type of insurance policy and claim situation. Common documents include the policy document, completed claim form, medical reports, hospital bills, and identity proof.',
          },
        },
        {
          '@type': 'Question',
          name: 'Why do insurance claims get rejected?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Claims may be rejected due to incomplete or incorrect documentation, delay in submission, policy exclusions, non-disclosure of information at the time of purchase, or disagreements over policy interpretation.',
          },
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F9]">
      ...
      <Helmet prioritizeSeoTags>
        {/* Primary */}
        <title>Insurance Claim Rejection Help India | Yashoda Total Solution</title>
        <meta
          name="description"
          content="Has your insurance claim been rejected? Yashoda Total Solution helps policyholders challenge rejections due to incomplete documents, policy exclusions, or missed deadlines. Escalate to IRDAI & Insurance Ombudsman. Free consultation."
        />
        <meta
          name="keywords"
          content="insurance claim rejection India, rejected insurance claim help, insurance claim denial assistance, challenge insurance rejection, insurance ombudsman complaint India, IRDAI complaint claim rejection, insurance claim appeal India, claim rejection Mumbai"
        />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta name="author" content="Yashoda Total Solution" />

        {/* Canonical */}
        <link rel="canonical" href="https://www.yashodatotalsolution.in/claim-rejection/" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.yashodatotalsolution.in/claim-rejection/" />
        <meta property="og:title" content="Insurance Claim Rejection Help India | Yashoda Total Solution" />
        <meta
          property="og:description"
          content="Has your insurance claim been rejected? We help policyholders understand rejection reasons, prepare appeals, and escalate to the Insurance Ombudsman or IRDAI. Expert team with high success rate."
        />
        <meta property="og:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Insurance Claim Rejection Help – Yashoda Total Solution" />
        <meta property="og:site_name" content="Yashoda Total Solution" />
        <meta property="og:locale" content="en_IN" />

        {/* Twitter / X Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Insurance Claim Rejection Help India | Yashoda Total Solution" />
        <meta
          name="twitter:description"
          content="Has your insurance claim been rejected? We help policyholders challenge rejections and escalate to IRDAI and Insurance Ombudsman."
        />
        <meta name="twitter:image" content="https://www.yashodatotalsolution.in/og-image.jpg" />
        <meta name="twitter:image:alt" content="Insurance Claim Rejection Help – Yashoda Total Solution" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(CLAIM_REJECTION_STRUCTURED_DATA)}
        </script>
      </Helmet>
      ...
      <section
        ...
        aria-labelledby="claim-rejection-hero-heading"
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h1
                id="claim-rejection-hero-heading"
      ...
      <section
        ...
        aria-labelledby="what-is-claim-rejection-heading"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2
              id="what-is-claim-rejection-heading"
            ...
            <div className="prose prose-lg max-w-none text-[#52606D]">
              ...
              <p className="leading-relaxed mb-4">
                {t('what_claim_rej_description1')}{' '}
                <strong>{t('what_claim_rej_description2')}</strong>
              </p>
              <p className="leading-relaxed mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-semibold text-red-600 mb-2">
                      {t('ex_scenario_claim_rej_example_head1')}
                    </h4>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              { q: t('faq_claim_rej_q1'), a: t('faq_claim_rej_a1') },
              { q: t('faq_claim_rej_q2'), a: t('faq_claim_rej_a2') },
              { q: t('faq_claim_rej_q3'), a: t('faq_claim_rej_a3') },
              { q: t('faq_claim_rej_q4'), a: t('faq_claim_rej_a4') },
            ].map((faq, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  ...
                  aria-label="Get free consultation for insurance claim rejection"
                >
