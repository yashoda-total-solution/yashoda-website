        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:[grid-template-columns:1.2fr_1fr_1.5fr_1.2fr]">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_home')}</Link></li>
              <li><Link to="/about" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_about')}</Link></li>
              <li><Link to="/contact" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_contact')}</Link></li>
              <li><Link to="/faqs" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_faqs')}</Link></li>
              <li><Link to="/partner" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_partner')}</Link></li>
              <li><Link to="/gallery" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_gallery')}</Link></li>
              <li><Link to="/reviews" className="text-sm text-gray-300 hover:text-[#F39C12] hover:translate-x-1 transition-all duration-200">{t('nav_reviews')}</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+919649647790" className="text-sm text-gray-300 hover:text-[#F39C12]">+91 9649647790</a>
                </div>
              </li>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@yashodatotalsolution.com?subject=Inquiry from Website" className="text-sm text-gray-300 hover:text-[#F39C12] break-all">
